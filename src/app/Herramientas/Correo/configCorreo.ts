...
export class configCorreo {
    cuerpoCorreo(opcion:any){
        ...
        if(opcion==1){
            ...
            respuesta='Puede corroborar dicha informaci&oacute;n ingresando a <a href="https://planificacion.espoch.edu.ec" target="_blank">https://planificacion.espoch.edu.ec</a> con su correo institucional si posee uno, caso contrario debe ingresar con su n&uacute;mero de c&eacute;dula como usuario y contrase&ntilde;a. <br>Ante cualquier cambio; por favor, realizarlo por este medio, a su vez ponerse en contacto con el administrador.';
        }else{
